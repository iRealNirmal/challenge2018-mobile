...
var map = {
	...
	"./detail-view/detail-view.module": [
...
var routes = [
    { path: '', loadChildren: './tabs/tabs.module#TabsPageModule', canActivate: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
    { path: 'login', loadChildren: './login/login.module#LoginPageModule', canActivateChild: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
    { path: 'signup', loadChildren: './signup/signup.module#SignupPageModule', canActivateChild: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
    { path: 'profiles', loadChildren: './profiles/profiles.module#ProfilesPageModule', canActivate: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
    { path: 'nearme', loadChildren: './nearme/nearme.module#NearmePageModule', canActivate: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
    { path: 'detailView/:id', loadChildren: './detail-view/detail-view.module#DetailViewPageModule', canActivate: [_service_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]], },
...
var TokenInterceptor = /** @class */ (function () {
    function TokenInterceptor(loadingController) {
    ...
    TokenInterceptor.prototype.intercept = function (request, next) {
        ...
        this.presentLoading();
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function () {
            setTimeout(function () {
                if (_this.loading) {
    ...
    TokenInterceptor.prototype.presentLoading = function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _authntication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./authntication.service */ "./src/app/service/authntication.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuardService = /** @class */ (function () {
    ...
    AuthGuardService = __decorate([
        ...
        __metadata("design:paramtypes", [_authntication_service__WEBPACK_IMPORTED_MODULE_2__["AuthnticationService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], AuthGuardService);
...
/***/ "./src/app/service/authntication.service.ts":
/*!**************************************************!*\
  !*** ./src/app/service/authntication.service.ts ***!
  \**************************************************/
/*! exports provided: AuthnticationService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthnticationService", function() { return AuthnticationService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AuthnticationService = /** @class */ (function () {
    function AuthnticationService(http, storage) {
        this.http = http;
        this.storage = storage;
        this.isLoggedin = false;
    }
    AuthnticationService.prototype.register = function (data) {
        var httpOptions = {
    ...
    AuthnticationService.prototype.login = function (data) {
        var _this = this;
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json'
    ...
    AuthnticationService.prototype.authenticate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthnticationService.prototype.logout = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthnticationService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
    ...
    ], AuthnticationService);
    return AuthnticationService;
}());
...
module.exports = __webpack_require__(/*! D:\learn\node\capegemini\mobile-app\loyalityApps\src\main.ts */"./src/main.ts");
